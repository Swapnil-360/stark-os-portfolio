...
export const INITIAL_PROJECTS: Project[] = [
  ...
  },
  {
    ...
    title: "Portfolio for Prince",
    subtitle: "High-Conversion Client Portfolio (First Customer Commission)",
    category: "web",
    categoryLabel: "Client Web Experience",
    shortDescription: "Custom bespoke digital portfolio engineered for first paying client, featuring Next.js, Framer Motion, and high-conversion visual design.",
    fullDescription: "First professional client commission where I took the customer's vision and crafted a living digital presence. Engineered with precision micro-interactions, responsive typography, and blazing fast performance to drive client conversions.",
    ...
    year: "2026",
    keyFeatures: [
      "Custom client commission tailored for personal branding (Branch: main)",
