...
(
    ...
    95,
    '["React","JavaScript","Tailwind CSS","Web Development","Crypto Marketing"]'::jsonb,
    '[{"label":"Client Satisfaction","value":"100%"},{"label":"Page Performance","value":"98/100"},{"label":"Design System","value":"Bespoke"}]'::jsonb,
    '["/images/projects/prince.jpg","/images/projects/prince_real.png"]'::jsonb
),
(
    'proj-7',
    'Pawfect Match',
